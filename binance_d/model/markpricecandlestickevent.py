...
class MarkPriceCandlestickEvent:

    def __init__(self):
        self.eventType = ""
        self.eventTime = 0
        self.symbol = ""
        self.data = MarkPriceCandlestick()

    @staticmethod
    def json_parse(json_wrapper):
        candlestick_event = MarkPriceCandlestickEvent()
        candlestick_event.eventType = json_wrapper.get_string("e")
        candlestick_event.eventTime = json_wrapper.get_int("E")
        candlestick_event.pair = json_wrapper.get_string("ps")
        data = MarkPriceCandlestick.json_parse(json_wrapper.get_object("k"))
