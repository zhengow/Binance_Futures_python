...
class IndexCandlestickEvent:

    def __init__(self):
        self.eventType = ""
        self.eventTime = 0
        self.symbol = ""
        self.data = IndexCandlestick()

    @staticmethod
    def json_parse(json_wrapper):
        candlestick_event = IndexCandlestickEvent()
        ...
        data = IndexCandlestick.json_parse(json_wrapper.get_object("k"))
